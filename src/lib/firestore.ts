...
const SEED_GIGS: Omit<Gig, 'id'>[] = [
  ...
  { title: "Website Development — E-commerce", company: "Fashion Boutique", description: "Need a full-stack developer to build an e-commerce website with payment integration, product catalog, and admin panel.", budget: "$2,500", applicants: 8, postedDate: "1 week ago", location: "Hybrid", category: "Dev", skills: ["React", "Node.js", "E-commerce"] },
  { title: "Social Media Content Creation", company: "Tech Startup", description: "Seeking a creative content creator to produce engaging social media posts, reels, and stories. Must have experience with Instagram and TikTok.", budget: "$800/mo", applicants: 15, postedDate: "3 days ago", location: "Remote", category: "Marketing", skills: ["Content Creation", "Social Media", "Video Editing"] },
  { title: "Mobile App UI/UX Design", company: "Fitness App Co.", description: "Looking for an experienced UI/UX designer to redesign our fitness tracking app. Need wireframes, mockups, and interactive prototypes.", budget: "$1,200", applicants: 20, postedDate: "5 days ago", location: "Remote", category: "Design", skills: ["UI/UX", "Figma", "Mobile Design"] },
...
const SEED_STUDENTS: Omit<StudentProfile, 'id'>[] = [
  {
    name: "Sarah Johnson", major: "Graphic Design", year: "Senior", university: "State University",
    ...
    education: { degree: "Bachelor of Fine Arts in Graphic Design", university: "State University", period: "2021 – 2025", gpa: "3.8 / 4.0" },
    portfolio: [
    ...
    whatsappNumber: "+15551234567", whatsappEnabled: true,
    reviews: [
  ...
  {
    name: "Marcus Williams", major: "Computer Science", year: "Junior", university: "Tech University",
    ...
    education: { degree: "Bachelor of Science in Computer Science", university: "Tech University", period: "2022 – 2026", gpa: "3.9 / 4.0" },
    portfolio: [
    ...
    whatsappNumber: "+15552345678", whatsappEnabled: false,
    reviews: [
  ...
  {
    name: "Aisha Patel", major: "Marketing", year: "Sophomore", university: "Business College",
    ...
    education: { degree: "Bachelor of Business Administration in Marketing", university: "Business College", period: "2024 – 2028", gpa: "4.0 / 4.0" },
    portfolio: [
    ...
    whatsappNumber: "+15553456789", whatsappEnabled: true,
    reviews: [
...
const SEED_VERIFICATIONS: Omit<PendingVerification, 'id'>[] = [
  { name: "Emily Rodriguez", email: "emily.r@university.edu", major: "Computer Science", year: "Junior", studentId: "STU-2023-4567", idImage: "https://images.unsplash.com/photo-1668903678359-e810dd966016?w=600&h=350&fit=crop&auto=format", submittedDate: "May 30, 2026" },
  { name: "James Wilson", email: "j.wilson@university.edu", major: "Graphic Design", year: "Senior", studentId: "STU-2021-8901", idImage: "https://images.unsplash.com/photo-1668903678359-e810dd966016?w=600&h=350&fit=crop&auto=format", submittedDate: "June 1, 2026" },
];

const SEED_FLAGGED: Omit<FlaggedItem, 'id'>[] = [
...
export async function seedFirestore() {
  ...
  if (usersSnap.empty) {
    const adminUsers: Omit<AdminUser, 'id'>[] = [
      { name: "Sarah Johnson", email: "sarah.j@university.edu", role: "Student", verificationStatus: "Verified", joinDate: "Jan 2026", gigs: 15 },
      { name: "Michael Chen", email: "m.chen@business.com", role: "Client", verificationStatus: "Verified", joinDate: "Feb 2026", gigs: 3 },
      { name: "Emily Rodriguez", email: "emily.r@university.edu", role: "Student", verificationStatus: "Pending", joinDate: "May 2026", gigs: 0 },
